...
from postproject import app, db, bcrypt
from postproject.forms import RegistrationForm, LoginForm, UpdateAccountForm
from postproject.models import User, Post
